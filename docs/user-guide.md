...
Usage of kube-router:
  ...
  -h, --help                                          Print usage information.
      ...
      --use-nftables-for-netpol                       [Experimental] Use nftables instead of iptables for the network policy controller. Requires nft >= 1.0.1 and kernel nftables support. See [the nftables page](./nftables.md) for details.
